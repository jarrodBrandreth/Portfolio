...
const plantShop:ProjectObj = {
  ...
  qrCode:qrPlantShop,
  description:'Foo Coding final project tasked with grasping the fundamentals of React. I built a e-commerce front end using React with TypeScript and JSON placeholder REST API to fetch data. Shopping cart, product views, sort by features and search filtering.',
...
const pokemonFun:ProjectObj = {
 name:'PokéFun',
  image:pokemonImage,
  qrCode:qrPokemonFun,
  description:'Using the PokeApi RESTful api to fetch data, I built a word and image guessing game with React and TypeScript. Contains the ability to play games seperately or play tournament mode and collect points. Has keyboard functionality as well as a graphical keyboard. Have fun!',
  stack: 'React, TypeScript',
...
const skatemaps:ProjectObj = {
 name:'NYC Skatemaps',
  ...
  qrCode:qrSkatemaps,
  description:'A MERN full-stack app of popular destinations for skateboarders in New York City. Contains admin panel and a personalized map for users to bookmark, create, edit or delete your own locations. *server is currently hosted for free so initial load may take some time.',
